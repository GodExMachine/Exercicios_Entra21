...
//testemudei aqui ó viu
	...
	(10) Escreva uma função para receber um vetor A de números inteiros. A função deve retornar um vetor contendo o fatorial de cada elemento do vetor A. 

	(11) Escreva uma função para receber um vetor A de números inteiros e retornar o maior valor do vetor.

	(12) Escreva uma função para receber uma matriz A contendo números inteiros e retornar a soma dos seus elementos.

	(13) Escreva uma função para receber uma matriz A contendo números inteiros e retornar a soma dos elementos da diagonal principal.

	(14) Escreva uma função para receber uma matriz A contendo números inteiros e retornar o menor elemento da sua diagonal principal.

	(15) Escreva uma função para receber duas matrizes A e B e retornar a matriz C que seja o produto matricial de A por B.
